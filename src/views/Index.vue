<template>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <router-link tag="li" active-class='active' :to="{name:'home'}">
          <a href="#">
            <i class="fa fa-link"></i> <span>首页</span>
          </a>
        </router-link>

        <router-link tag="li" active-class='active' :to="{name:'positionList'}">
          <a href="#">
            <i class="fa fa-link"></i> <span>职位管理</span>
          </a>
        </router-link>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-link"></i> <span>我的管理</span>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">千锋GP6</a>.</strong> All rights reserved.
  </footer>
